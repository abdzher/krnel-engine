...
> Esta es una copia del repositorio [coder2j/pyspark-tutorial](https://github.com/coder2j/pyspark-tutorial), la licencia original está incluída en esta misma carpeta, cualquier modificación estará indicada en su mismo Notebook.
> 
