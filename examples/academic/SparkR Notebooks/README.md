...
> Esta es una copia del repositorio [jadianes/spark-r-notebooks](https://github.com/jadianes/spark-r-notebooks), la licencia original está incluída en esta misma carpeta, cualquier modificación estará indicada en su mismo Notebook.
> 
