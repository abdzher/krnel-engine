...
> Esta es una copia del repositorio [ipython-books/cookbook-2nd-code](https://github.com/ipython-books/cookbook-2nd-code), la licencia original está incluída en esta misma carpeta, cualquier modificación estará indicada en su mismo Notebook.
> 
> Por favor, revisa el material original (enlace en el nombre del repositorio).
